      ...
      <header className="shell-header sticky top-0 z-20">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/auth/register"><Button className="rounded-full">Get Started</Button></Link>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 space-y-4">
          {faqs.map(([question, answer]) => (
            <Card key={question} className="surface-card rounded-[1.85rem] shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
